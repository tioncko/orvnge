...
@WebServlet("/listar-mov-mes")
public class ListarMovMesServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        JSONArray arr = service.ListarMovMes(cpf, Integer.parseInt(idCli), mes, tipoMov);
